...
class RamedisPatientGenerator(PatientGenerator):
	def __init__(self, hpo_reader=HPOReader()):
		...
		self.hpo_to_death_year_range = {
			'HP:0003811': (0.0, 28/365),   # neonatal mortality; <= 28 day
			'HP:0001522': (0.0, 2.0),   # infant mortality; <= 24 month
			'HP:0003819': (2.0, 10.0),  # childhood mortality; 2 ~ 10 year
			'HP:0011421': (10.0, 19.0),   # adolescent mortality; 10 ~ 19 year
			'HP:0100613': (16.0, 40.0),   # early adult mortality; 16 ~ 40 year
		}
...
if __name__ == '__main__':
	...
	# rpg.gen_symptom_auto_match_csv()
	# rpg.gen_lab_finding_auto_match_csv()
	# print('\n'.join(rpg.get_sym_range_type('Headache')))
	# print('\n'.join(rpg.get_all_range_type()))
	# print('\n'.join(rpg.get_sym_age_type('previous deaths')))
	# print(rpg.check_dis_code())

	# rpg.gen_disease_auto_match_csv()
	# print(rpg.get_omim_map_all_labels())

	# print(rpg.get_death_year('4 Day(s)'))
	# print(rpg.get_death_year('4.43 Week(s)'))
	# print(rpg.get_death_year('2.99 Month(s)'))
	# print(rpg.get_death_year('2.27 Year(s)'))
	# print(rpg.death_age_to_hpos('2.99 Month(s)'))
	# rpg.get_sym_name_range_map_hpos()
	# print('get_all_diag_confirm:', rpg.get_all_diag_confirm())
	# print('get_all_new_born_screen:', rpg.get_all_new_born_screen())
